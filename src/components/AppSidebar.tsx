import {
  LayoutDashboard, Users, Contact, Kanban, Settings, LogOut, Building2, FileText, TrendingUp, Share2, Mail, MailPlus, Send,
} from "lucide-react";
...
const marketingItems: { title: string; url: string; icon: any; adminOnly?: boolean }[] = [
  { title: "Social Queue", url: "/social-queue", icon: Send },
];
