...
import { Building2, Briefcase, Paperclip, Plus, Download, FileText } from "lucide-react";
...
export function RightRail({ companies, deals, attachments, onUpload, onAddCompany, onSignedUrl }: Props) {
  return (
