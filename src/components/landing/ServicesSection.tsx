import { Home, Building2, Shield, RefreshCw } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service) => (
            <div key={service.title} className="card-elevated group p-6 transition-transform hover:-translate-y-1">
